...
//$config['smtp_password'] = 'monopoly2017';  //Измените пароль
...
//$config['smtp_username'] = 'c8c2e5f4f083eb';  //Смените на адрес своего почтового ящика.
//$config['smtp_port'] = '2525'; // Порт работы.
//$config['smtp_host'] =  'smtp.mailtrap.io';  //сервер для отправки почты
//$config['smtp_password'] = 'abd8290df2a0fc';  //Измените пароль
//$config['smtp_debug'] = true;  //Если Вы хотите видеть сообщения ошибок, укажите true вместо false
//$config['smtp_charset'] = 'utf-8';	//кодировка сообщений. (windows-1251 или utf-8, итд)
//$config['smtp_from'] = 'Монополия Крым'; //Ваше имя - или имя Вашего сайта. Будет показывать при прочтении в поле "От кого"
